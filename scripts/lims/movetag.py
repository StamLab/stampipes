...
def parser_setup():
    ...
    parser.add_argument(
        "--content_type", dest="content_type", help="Name of the contenttype."
    )
    parser.add_argument("--object", dest="object_id", type=int, help="Object ID.")

    parser.add_argument("-a", "--add_tag", dest="new_tag", help="The new tag slug.")
    parser.add_argument("-r", "--remove_tag", dest="old_tag", help="The old tag slug.")
...
class TagChange(object):
    ...
    def change_tag(self, contenttype, object_id, old_tag, new_tag):
        ...
        current = requests.get(
            "%s/tagged_object/?content_type=%d&object_id=%d&tag__slug=%s"
            % (self.api_url, contenttype_id, object_id, old_tag),
        ...
        result = requests.put(
            taggedobject["url"], headers=self.headers, data=taggedobject
        )
...
def main(args=sys.argv):
    ...
    result = tagchange.change_tag(
        poptions.content_type, poptions.object_id, poptions.old_tag, poptions.new_tag
    )
